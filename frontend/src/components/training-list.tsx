...
export const TrainingList = () => {
  const trainings = [
    ...
    },
    {
      ...
      description:
        "Training on providing mental health support to those in need.",
    ...
    },
    {
      ...
      description:
        "Guidance and support for mentoring young individuals in the community.",
    ...
    },
    {
      ...
      description:
        "Learn how to effectively respond to and manage disaster situations.",
